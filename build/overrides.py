...
_FIXES = [
    ...
    ("KATSEYE",      "Sophia Laforteza",  "Sophia",      "KATSEYE go by first names"),
    ("KATSEYE",      "Daniela Avanzini",  "Daniela",     "KATSEYE go by first names"),
    ("KATSEYE",      "Lara Raj",          "Lara",        "KATSEYE go by first names"),
    ("KATSEYE",      "Megan Skiendiel",   "Megan",       "KATSEYE go by first names"),
    ("KATSEYE",      "Manon Bannerman",   "Manon",       "KATSEYE go by first names"),
    ("KATSEYE",      "Yoonchae Jeung",    "Yoonchae",    "KATSEYE go by first names"),
